namespace DungeonEye.Forms
{
	partial class DecorationForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.DisplayWallBox.CheckedChanged += new System.EventHandler(this.DisplayWallBox_CheckedChanged);
			// 
			// label1
			// 
			...
			this.BackgroundTileSetBox.SelectedIndexChanged += new System.EventHandler(this.TileSetListBox_SelectedIndexChanged);
			// 
			// groupBox2
			// 
